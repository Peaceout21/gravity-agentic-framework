...
class IngestionAgent(BaseAgent):
    def __init__(self, event_bus, graph_runtime, tickers, poll_interval_seconds=300, market="US_SEC"):
    ...
    def start(self):
        self.running = True
        while self.running:
            payloads = self.graph_runtime.run_ingestion_cycle(self.tickers, market=self.market)
